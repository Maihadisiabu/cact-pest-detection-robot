...
> **Paper:** "Context-Aware IoT–CNN Fusion for False-Positive Reduction in Edge-Based Simulated Pest Detection: A Proof-of-Concept Tropical Smallholder Robot Study"
...
> **Note — Proof-of-concept study:** All evaluations used artificial pest decoys (printed photographic representations) as a controlled proxy for live insects. The reported metrics reflect performance under simulated conditions; live-infestation validation is a required next step before operational deployment.
...
@article{maihadisi2026cact,
  title   = {Context-Aware {IoT}--{CNN} Fusion for False-Positive Reduction in
             Edge-Based Simulated Pest Detection: A Proof-of-Concept Tropical Smallholder Robot Study},
